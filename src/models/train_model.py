...
pca_featurs = ["pca_1", "pca_2", "pca_3"]
time_features = [f for f in df_train.columns if "_temp_" in f]
frequency_features = [f for f in df_train.columns if ("_temp_" in f) or ("_pse" in f)]
cluster_features = ["cluster"]

print("Basic Features", len(basic_features))
print("Square Features", len(square_features))
print("PCA Features", len(pca_featurs))
print("Time Features", len(time_features))
print("Frequency Features", len(frequency_features))
print("Cluster Features", len(cluster_features))

feature_set_1 = list(set(basic_features))
feature_set_2 = list(set(feature_set_1 + square_features + pca_featurs))
...
# --------------------------------------------------------------
# Try a more complex model with the selected features and all features
# --------------------------------------------------------------
